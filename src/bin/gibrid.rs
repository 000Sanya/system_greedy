...
fn main() {
    ...
    println!("{} {}", states.minimal_state.energy, states.minimal_state.state);

    system.set_system_state(states.minimal_state.state.clone());
    ...
    system.save_in_excel(format!("{dir_name}/algorithm.xlsx"), 0.0);
